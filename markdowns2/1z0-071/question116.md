...
All conditions evaluated using CASE can also be evaluated using DECODE. C.

All conditions evaluated using DECODE can also be evaluated using CASE. D.

B. Neither CASE nor DECODE is a function.

Both CASE and DECODE are functions. F.

DECODE is a function and CASE is not. E.
