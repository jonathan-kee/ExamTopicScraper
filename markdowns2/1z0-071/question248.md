...
# Answers
ALTER can be granted only on tables and sequences. D.
...
## Discussion 2
- UPDATE can be granted only on tables and views - ALTER is valid for tables and sequences but not views. - REFERENCES can be granted only on tables and views.
