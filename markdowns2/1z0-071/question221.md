...
# Answers
A TIMESTAMP data type column contains information about year, month, and day. E.

A TIMESTAMP WITH LOCAL TIMEZONE data type column is stored in the database using the time zone of the session that inserted the row. A.
