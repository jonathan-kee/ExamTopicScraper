...
An alias name must always be specified in quotes. B.

An alias name must not be used in a GROUP BY clause. D.

An alias name must not be used in an ORDER BY clause. C.
