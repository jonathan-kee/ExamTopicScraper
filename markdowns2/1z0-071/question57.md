...
# Answers
Add a new column as the table's first column. B.

Add a new NOT NULL column with a DEFAULT value. F.
...
Change a DATE column containing data to a NUMBER data type. D.

Change the default value of a column. E.
